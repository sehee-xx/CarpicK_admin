...
export default function PrivacyPage() {
  return (
    <S.Wrapper>
      ...
      <S.Box>
        <S.Text isBold={true}>제 1조(개인정보의 처리 목적)</S.Text>
        <S.Text isBold={true}>
          <i>
            ('카픽 모바일 앱 서비스'이하 '카픽')은 다음의 목적을 위하여
        ...
        <S.Box marginLeft="50">
          <S.Text>1. 서비스 회원가입 및 관리</S.Text>
          <S.Text>
            회원 가입의사 확인, 회원제 서비스 제공에 따른 본인 식별·인증,
            회원자격 유지·관리, 서비스 부정이용 방지, 각종 고지·통지 목적으로
            개인정보를 처리합니다.
          </S.Text>
          <S.Text>2. 재화 또는 서비스 제공</S.Text>
          <S.Text>
            서비스 제공, 콘텐츠 제공, 본인인증, 운전면허인증 목적으로 개인정보를
            처리합니다.
          </S.Text>
        </S.Box>
      </S.Box>
      <S.Box>
        <S.Text isBold={true}>제 2조(개인정보의 처리 및 보유기간)</S.Text>
        <S.Text>
          &#9312; '카픽'은 법령에 따른 개인정보 보유·이용기간 또는
        ...
        <S.Box marginLeft="50">
          <ul>
            <li>1.&lt;서비스 회원가입 및 관리&gt;</li>
            <li>
              &lt;서비스 회원가입 및 관리&gt;와 관련한 개인정보는 수집, 이용에
              관한 동의일로부터 &lt;지체없이 파기&gt;까지 위 이용목적을 위하여
              보유, 이용됩니다.
            </li>
            <li>보유근거 : 제공되는 서비스 이용을 위한 목적</li>
          </ul>
        </S.Box>
      </S.Box>
      <S.Box>
        <S.Text isBold={true}>제 3조(처리하는 개인정보의 항목)</S.Text>
        <S.Text>
          &#9312; '카픽'은 다음의 개인정보 항목을 처리하고 있습니다.
        </S.Text>
        <S.Box marginLeft="50">
          <ul>
            <li>1.&lt;서비스 회원가입 및 관리&gt;</li>
            <li>필수항목 : 이메일, 비밀번호, 이름, 휴대전화번호, 운전면허증</li>
          </ul>
        </S.Box>
      </S.Box>
      <S.Box>
        <S.Text isBold={true}>제 4조(개인정보의 파기절차 및 파기방법)</S.Text>
        <S.Text>
          &#9312; '카픽'은 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가
        ...
        <S.Text>
          ...
          <i>
            1. 파기절차
            <br />
            '카픽'은 파기 사유가 발생한 개인정보를 선정하고, '카픽'의 개인정보
      ...
      <S.Box>
        ...
        <S.Text>
          &#9312; 정보주체는 카픽에 대해 언제든지 개인정보
          열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.
        </S.Text>
        <S.Text>
          &#9313; 제1항에 따른 권리 행사는 카픽에 대해 「개인정보 보호법」
          시행령 제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여
          하실 수 있으며 카픽은 이에 대해 지체 없이 조치하겠습니다.
        </S.Text>
        <S.Text>
        ...
        <S.Text>
          &#9317; 카픽은 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구,
      ...
      <S.Box>
        ...
        <S.Text isBold={true}>
          <i>
            카픽은 개인정보의 안전성 확보를 위해 다음과 같은 조치를 취하고
            있습니다.
          </i>
        </S.Text>
        <S.Text>
      ...
      <S.Box>
        ...
        <S.Text>
          카픽은 정보주체의 이용정보를 저장하고 수시로 불러오는 '쿠키(cookie)를
          사용하지 않습니다.'
        </S.Text>
      </S.Box>
      <S.Box>
        ...
        <S.Text>행태정보의 수집·이용·제공 및 거부등에 관한 사항</S.Text>
        <S.Text>
          카픽은 온라인 맞춤형 광고 등을 위한 행태정보를 수집·이용·제공하지
          않습니다.
        </S.Text>
      </S.Box>
      <S.Box>
        <S.Text isBold={true}>제9조 (개인정보 보호책임자에 관한 사항)</S.Text>
        <S.Text>
          &#9312; 카픽은 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보
        ...
        <S.Box marginLeft="50">
          <ul>
            ...
            <li>직책 : 관리자</li>
            <li>직급 : 관리자</li>
            <li>연락처 : 010-4816-8681, yeontan0826@gmail.com</li>
          </ul>
        </S.Box>
        <S.Text>
          &#9313; 정보주체께서는 카픽을 이용하시면서 발생한 모든 개인정보 보호
          관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및
          담당부서로 문의하실 수 있습니다. 카픽은 정보주체의 문의에 대해 지체
          없이 답변 및 처리해드릴 것입니다.
        </S.Text>
      </S.Box>
      <S.Box>
        ...
        <S.Text isBold={true}>
          <i>
            ...
            아래의 부서에 할 수 있습니다.
            <br />
            카픽은 정보주체의 개인정보 열람청구가 신속하게 처리되도록
            노력하겠습니다.
          </i>
        </S.Text>
        <S.Box marginLeft="50">
