            ...
            <Fade cascade>
              ...
              <S.SecondBottomDiv>
                  <S.SecondContents>
                    ...
                    서로 대여해 주고 차용해 쓰는 <br/>
                    <strong style={{ fontSize: "30px", color: "#5d8bff" }}>공유</strong>의 개념이 되고 있습니다
                  </S.SecondContents>
        ...
        <S.ThirdPage>
          <Fade cascade>
            ...
            <S.ThirdContents>
              ...
              <strong style={{ color: "#5d8bff" }}>지금 바로 카픽에서 오너등록 하세요!</strong>
            </S.ThirdContents>
          </Fade>
        </S.ThirdPage>
        <S.LineHr />
          ...
          <Fade cascade>
            ...
            <S.FourthBottomDiv>
                <S.FourthContents>
                  ...
                  <strong style={{ color: "#5d8bff" }}>지금 바로 카픽에서 체험해보세요!</strong>
                </S.FourthContents>
